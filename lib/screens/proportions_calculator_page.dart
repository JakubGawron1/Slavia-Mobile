...
class _ProportionsCalculatorPageState extends State<ProportionsCalculatorPage> {
  ...
  void _calculate() {
    ...
    for (var entry in _controllers.entries) {
      inputs[entry.key] = double.tryParse(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    r.status == 'in_range'
                        ? 'W normie'
                        : (r.status == 'below' ? 'Poniżej' : 'Powyżej'),
                    style: TextStyle(
                      color: statusColor,
                      fontSize: 12,
                      fontWeight: FontWeight.bold,
            ...
            Row(
              ...
              children: [
                Text(
                  'Sugerowane: ${r.minKg!.toStringAsFixed(1)} - ${r.maxKg!.toStringAsFixed(1)} kg',
                ),
                if (r.actualKg != null)
                  Text(
                    'Masz: ${r.actualKg!.toStringAsFixed(1)} kg',
