        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Konto nie jest powiązane z profilem zawodnika.',
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => _showAddResultDialog(
          athleteId,
          api,
          _tabController.index == 2 ? 'training' : 'competition',
        ),
        icon: const Icon(Icons.add),
        label: Text(
          _tabController.index == 2 ? 'Dodaj trening' : 'Zgłoś start',
        ),
      ),
    );
  }
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _ResultField(ctrl: cjCtrl, label: 'Podrzut (kg)'),
                    ),
                  ],
                ),
                const SizedBox(height: 12),
                    ...
                    onPressed: () async {
                      ...
                      if (s == 0 && c == 0) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Podaj co najmniej jeden wynik'),
                          ),
                        );
                        return;
                      }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  kind == 'competition'
                      ? 'Brak zgłoszonych startów'
                      : 'Brak wpisów treningowych',
                  style: GoogleFonts.outfit(
                    fontSize: 16,
                    color: Colors.grey[600],
                  ),
                ...
                ElevatedButton.icon(
                  ...
                  icon: const Icon(Icons.add),
                  label: Text(
                    kind == 'competition' ? 'Zgłoś start' : 'Dodaj trening',
                  ),
                ),
              ],
            ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        if (r.snatch != null && r.cleanAndJerk != null)
                          const SizedBox(width: 8),
                        if (r.cleanAndJerk != null)
                          _ResultBadge(
                            label: 'Podrzut',
                            value: '${r.cleanAndJerk} kg',
                            color: Colors.blue,
                          ),
                        const Spacer(),
                        Column(
